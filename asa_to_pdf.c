...
void do_text(){
   ...
   for(i=0;i<GLOBAL_SHIFT;i++){buffer[i]=' ';}
...
case 1:
   ...
   fprintf(stderr," !-----------------                                                             |\n");
   fprintf(stderr," | # process non-ASA file in portrait mode with a dashed line under every line  |\n");
...
*/
   ...
   GLOBAL_PAGE_MARGIN_LEFT =   40.0;
   GLOBAL_PAGE_MARGIN_RIGHT =  39.0;
